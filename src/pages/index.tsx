  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Information System - Empowering Employers to Efficiently Manage Employee Data, Vacations, and Payroll with Ease and Precision"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Information System - Empowering Employers to Efficiently Manage Employee Data, Vacations, and Payroll with Ease and Precision`}
            </Text>
            <Box
